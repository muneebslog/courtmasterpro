        ...
        <header
            ...
            <div
                ...
                <a href="javascript:window.history.back()"
                    style="text-decoration: none; color: #D1D5DB; font-size: 14px; font-weight: 500;">&larr;
                    Back</a>
            </div>
        </header>
        ...
        <main style="width: 100%; max-width: 1000px; margin: 0 auto; box-sizing: border-box; padding: 24px 16px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 16px;">
                ...
                @forelse ($events as $event)
                    <a href="{{ url('viewer/events/' . $event->id . '/rounds') }}"
                        style="background-color: #0F1621; border: 1px solid #111827; border-radius: 8px; padding: 20px; cursor: pointer; transition: background-color 0.2s;"
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 6px;">
                            <span
                                style="background-color: #111827; border: 1px solid #374151; color: #D1D5DB; font-size: 11px; font-weight: 600; padding: 3px 8px; border-radius: 4px; text-transform: uppercase;">{{ $event->default_discipline }}</span>
                            <span
                                style="background-color: #111827; border: 1px solid #374151; color: #D1D5DB; font-size: 11px; font-weight: 600; padding: 3px 8px; border-radius: 4px; text-transform: uppercase;">{{ $event->type }}</span>
                            <span
                                style="background-color: #111827; border: 1px solid #374151; color: #D1D5DB; font-size: 11px; font-weight: 600; padding: 3px 8px; border-radius: 4px; text-transform: uppercase;">Bo{{ $event->best_of_sets }}</span>
                        </div>
                    </a>
                @empty
